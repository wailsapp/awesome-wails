...
- [Clustta](https://github.com/eaxum/clustta-client) - Файловый менеджер с открытым исходным кодом, инструмент для совместной работы и контроля версий для творческих проектов.
